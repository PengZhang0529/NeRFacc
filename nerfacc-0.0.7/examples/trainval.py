...
#from examples.datasets.nerf_synthetic import SubjectLoader, namedtuple_map
#from examples.radiance_fields.mlp import VanillaNeRFRadianceField
...
if __name__ == "__main__":
    ...
    train_dataset = SubjectLoader(
        subject_id=scene,
        root_fp="/home/zp/nerfacc-0.0.7/data/nerf_synthetic/",
