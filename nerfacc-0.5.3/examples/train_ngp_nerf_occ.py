...
parser.add_argument(
    ...
    type=str,
    #default="lego",
    default="room", #切换数据集为room时，debug时 把 'lego' 改成 'room', 在终端跑代码时，直接修改命令参数，即将 'python examples/train_ngp_nerf_occ.py --scene lego --data_root data/nerf_synthetic'，改为'python examples/train_ngp_nerf_occ.py --scene room --data_root data/nerf_synthetic'
